 ...
 * renamed to the console.* dark namespace so the revealed link reads correctly
 * on the dark surface.
 */
  ...
  return (
    <a
      ...
      className={cn(
        ...
        "focus:rounded-sm focus:border focus:border-console-edge focus:bg-console-panel",
        "focus:px-3 focus:py-1.5 focus:text-[11px] focus:text-console-ink",
        "focus:outline-none focus-visible:ring-1 focus-visible:ring-console-ink",
        className,
      )}
    >
      {children}
