      ...
      <article className="mx-auto max-w-3xl px-6 py-24">
        ...
        <footer className="mt-16 border-t border-edge pt-8">
          ...
          <div className="mt-3 flex flex-wrap gap-x-6 gap-y-2 text-sm">
            <Link
              href="/architecture"
              className="group inline-flex items-center gap-1 font-medium text-indigo-600 hover:text-indigo-700"
            >
              ...
              <ul className="mt-3 flex flex-col gap-3">
                {otherPosts.map((p) => (
                  <li key={p.slug}>
                    ...
                    >
                      <span className="text-[11px] uppercase tracking-section text-faint">
                        {p.date}
                      </span>
