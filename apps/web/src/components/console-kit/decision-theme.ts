 ...
 *
 * Ported verbatim from apps/console (ADR-128: copy, don't share). These use
 * default-tailwind decision classes (text-emerald-300, etc.), which read
 * correctly on the dark console surface — so NO token rename is applied here.
 */
