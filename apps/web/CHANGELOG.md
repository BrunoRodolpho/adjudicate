...
- efabb92: marketing(web): 133 — reconcile overstated marketing copy to code-truth.
  ...
  - **AuditChain.tsx / ConstitutionalKernelMap / MagicMomentSplit (C15/C16).**
    ...
    every record genesis as-built). Reframed "every decision _is_ a link in a
    cryptographic chain" → records _can be_ chained; separated byte-for-byte
