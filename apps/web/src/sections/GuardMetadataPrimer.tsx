    ...
    <Section tone="surface" className="pt-12">
      <Reveal className="max-w-3xl">
        ...
        <div className="mt-5 space-y-4 text-base leading-relaxed text-muted">
          <p>
            A <strong className="text-ink">guard</strong> is one rule in your
            policy — a function that inspects a proposed AI action and votes on
            what should happen to it.{" "}
            <strong className="text-ink">GuardMetadata</strong> is an optional
          ...
          <p>
            ...
            something tooling can <strong className="text-ink">read</strong>.
      ...
      <Stagger className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {KIND_ORDER.map((kind) => {
          ...
          return (
            ...
            >
              <code className="text-sm font-semibold text-ink">{kind}</code>
      ...
      <Reveal className="mt-6 max-w-3xl rounded-xl border border-defer/40 bg-defer/5 p-5">
        ...
        <p className="mt-2 text-sm leading-relaxed text-muted">
          ...
          metadata tags it as a <code className="font-mono text-ink">threshold</code>{" "}
