...
export function OutcomeChart({
  ...
  if (buckets.length === 0) {
    return (
      <div
        className="flex items-center justify-center rounded-sm border border-edge bg-panel/40 text-[11px] text-muted"
        style={{ height }}
      >
...
export function OutcomeChartLegend() {
  return (
    <div className="flex flex-wrap items-center gap-3 text-[10px] uppercase tracking-section text-faint">
